# PrivVault trust model (Level 3 demo)

This document states what PrivVault **does** and **does not** guarantee on the selected Midnight network. The Level 1 target is Midnight Preprod. Judges and operators should treat the product as a production-*minded* demo, not a hardened access-control system.
