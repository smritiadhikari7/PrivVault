````markdown
# PrivVault Architecture

## 1. Project Overview

PrivVault is a privacy-preserving credential and access-verification dApp built on the Midnight Network.
...
├── Documents/
│   ├── DEMO_CHECKLIST.md
│   ├── midnight_level3_PrivVault_plan.md
│   ├── PLAN.md
│   ├── PROPOSAL.md
│   └── TRUST_MODEL.md
│
...
ZK configuration loaded
        ↓
PrivVault contract joined or deployed
        ↓
...
PrivVault supports Midnight-compatible browser wallets through the dApp Connector API.
...
During proof generation, PrivVault can represent stages such as:
...
This is the main Compact smart contract and the source of the PrivVault circuits.
...
# 20. End-to-End PrivVault Flow

```text
1. User opens PrivVault
        ↓
...
PrivVault uses a clear separation of responsibility:
